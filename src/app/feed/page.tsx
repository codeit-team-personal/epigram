  ...
  return (
    <>
      <div className='lg:w-[1200px] md:w-[600px] w-[360px] mx-auto'>
        <div className='lg:mt-20 lg:mb-35 md:mt-10 md:mb-25 mt-10 mb-30 space-y-4'>
      ...
      {hasNextPage && (
        <>
          {/* 그라데이션 배경 */}
          <div className='fixed inset-x-0 bottom-22 h-20 bg-gradient-to-t from-background to-bg/10 pointer-events-none z-0 m-0 md:hidden' />

          <div className='sticky bottom-0 z-10 md:static'>
            <div className='flex justify-center mt-4 bg-background md:bg-transparent '>
              <Button
                className='flex items-center gap-2 rounded-full bg-background border border-line-200 px-4 py-2 lg:text-xl text-sm text-blue-500 hover:bg-gray-50 lg:w-[238px] lg:h-[56px] w-[153px] h-[48px] cursor-pointer mb-10'
                variant='outline'
